...
export function CachePage() {
  ...
  return <>
    ...
    {activity.loading ? <PageLoading /> : activity.error ? <PageError message={activity.error} retry={activity.retry} /> : <>
      ...
      <section className="panel"><div className="panel-header"><div><span className="eyebrow">Provider-side cache</span><h2>Cache token activity</h2></div></div><VerticalUsageChart data={activity.data} metric="cache" /></section>
