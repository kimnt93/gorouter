...
func TestSwaggerDocumentsEveryJSONRoute(t *testing.T) {
	...
	want := map[string][]string{
		...
		"/admin/credentials": {"get", "post"}, "/admin/credentials/{id}": {"put", "delete"}, "/admin/providers": {"get"}, "/admin/oauth/{provider}/start": {"post"}, "/admin/oauth/{provider}/complete": {"post"}, "/admin/credentials/{id}/test": {"post"}, "/admin/credentials/{id}/quota": {"get", "post"}, "/admin/credentials/{id}/models": {"get"}, "/admin/credentials/{id}/models/import": {"post"}, "/admin/credentials/{id}/models/refresh": {"post"}, "/admin/credentials/{id}/chat-tests": {"post"},
