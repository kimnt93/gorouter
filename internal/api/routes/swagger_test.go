...
func TestSwaggerDocumentsEveryJSONRoute(t *testing.T) {
	...
	want := map[string][]string{
		"/healthz": {"get"}, "/login": {"post"}, "/logout": {"post"}, "/admin/session": {"get"}, "/v1/chat/completions": {"post"}, "/v1/responses": {"post"}, "/v1/models": {"get"},
		...
		"/admin/credentials": {"get", "post"}, "/admin/credentials/{id}": {"put", "delete"}, "/admin/providers": {"get"}, "/admin/oauth/{provider}/start": {"post"}, "/admin/oauth/{provider}/complete": {"post"}, "/admin/credentials/{id}/test": {"post"}, "/admin/credentials/{id}/quota": {"get", "post"}, "/admin/credentials/{id}/models": {"get"}, "/admin/credentials/{id}/models/import": {"post"}, "/admin/credentials/{id}/chat-tests": {"post"},
