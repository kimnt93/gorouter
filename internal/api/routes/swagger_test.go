...
func TestSwaggerDocumentsEveryJSONRoute(t *testing.T) {
	...
	want := map[string][]string{
		...
		"/admin/credentials": {"get", "post"}, "/admin/credentials/{id}": {"put", "delete"}, "/admin/providers": {"get"}, "/admin/oauth/{provider}/start": {"post"}, "/admin/oauth/{provider}/complete": {"post"}, "/admin/credentials/{id}/test": {"post"}, "/admin/credentials/{id}/quota": {"get", "post"}, "/admin/credentials/{id}/select": {"post"}, "/admin/credentials/{id}/reset-credits": {"get", "post"}, "/admin/credentials/{id}/models": {"get"}, "/admin/credentials/{id}/models/import": {"post"}, "/admin/credentials/{id}/models/refresh": {"post"}, "/admin/credentials/{id}/chat-tests": {"post"},
		"/admin/api-keys": {"get", "post"}, "/admin/api-keys/models": {"get"}, "/admin/api-keys/{id}": {"patch", "delete"}, "/admin/api-keys/{id}/reveal": {"get"}, "/admin/api-keys/{id}/rotate": {"post"}, "/admin/models": {"get"}, "/admin/models/{name}": {"put", "delete"}, "/admin/prices": {"get"}, "/admin/prices/{model}": {"put", "delete"}, "/admin/pricing/catalog": {"get"}, "/admin/pricing/estimate": {"get"}, "/admin/usage/summary": {"get"}, "/admin/usage/workloads/weekly": {"get"}, "/admin/usage/recent": {"get"}, "/admin/usage/events/{id}": {"get"}, "/admin/usage/activity": {"get"}, "/admin/cache/stats": {"get"}, "/admin/cache/flush": {"post"},
	}
