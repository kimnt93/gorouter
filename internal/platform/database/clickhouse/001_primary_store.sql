...
CREATE TABLE IF NOT EXISTS usage_events (
    event_id String, ts DateTime64(3, 'UTC'), tenant_id String, api_key_id String,
...
) ENGINE = MergeTree PARTITION BY toYYYYMM(ts) ORDER BY (ts, tenant_id, api_key_id, event_id);
