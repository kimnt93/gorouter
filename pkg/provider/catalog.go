...
var definitions = []Definition{
	...
	{ID: "grok-build", Name: "Grok Build", Description: "Connect the Grok coding subscription using device authorization.", Auth: AuthOAuth, Protocol: ProtocolOpenAI, DefaultBaseURL: "https://cli-chat-proxy.grok.com/v1", ModelPrefix: "gb", OAuthSupported: true, OAuthRefreshRequired: true, QuotaSupported: true},
	...
	{ID: "devin-cli", Name: "Devin CLI", Description: "Use a Devin CLI apk_user key with the installed devin ACP binary; requires CLI in the router runtime.", Auth: AuthAPIKey, Protocol: ProtocolOpenAI, ModelPrefix: "dv"},
